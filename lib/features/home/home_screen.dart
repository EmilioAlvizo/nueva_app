    ...
    return Theme(
      ...
      child: Builder(
        builder: (ctx) => Scaffold(
          backgroundColor: _isDark ? AppColors.bgDark : const Color(0xFFF0F4F8),
          body: SafeArea(
            child: Column(
              children: [
                _buildAppBar(ctx),
      ...
      child: Row(
        children: [
          ...
          Text(
            'Granjas',
            style: TextStyle(
              color: _isDark ? AppColors.textPrimary : const Color(0xFF1A1A2E),
              fontSize: 22,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              height: 40,
              decoration: BoxDecoration(
                color: _isDark ? AppColors.bgCard : Colors.white,
                shape: BoxShape.circle,
                border: Border.all(
                  color: _isDark ? AppColors.border : const Color(0xFFD1D5DB),
                ),
              ),
              child: Icon(
  ...
  Widget _buildBottomBar(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          top: BorderSide(
            color: _isDark ? AppColors.border : const Color(0xFFE5E7EB),
          ),
        ),
      ),
      child: Row(
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(
                ...
                color: selected
                    ? AppColors.green
                    : (_isDark ? AppColors.textSecondary : const Color(0xFF9CA3AF)),
              ),
            ),
          );
        }),
    ...
    return Column(
      ...
      children: [
        Text(
          value,
          style: TextStyle(
            color: valueColor ?? (isDark ? AppColors.textPrimary : const Color(0xFF1A1A2E)),
            fontSize: 15,
